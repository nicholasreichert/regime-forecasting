...
Remove this paragraph and start section numbering with 1. For any questions, please contact the Preprints.org Editorial Office via \href{mailto:info@preprints.org}{info@preprints.org}. For LaTeX-related questions please contact \href{mailto:latex@mdpi.com}{latex@mdpi.com}.%\endnote{This is an endnote.} % To use endnotes, please un-comment \printendnotes below (before References). Only journal Laws uses \footnote.
...
\includegraphics[width=5.0 cm]{Definitions/logo-mdpi}
...
\bottomrule
\end{tabularx}
\noindent{\small{\textsuperscript{1} Tables may have a footer. This is a very long table footer example. The long table footer should be justified alignment.}}
\end{table}
...
\isPreprints{\centering}{} % Only used for preprints and the footer is only one line.
...
\multirow[m]{3}{*}{Entry 2}    & Data			& Data			& Data\\
			...
			\bottomrule
		\end{tabularx}
\noindent{\small{* Tables may have a footer. This is a short table footer. The short footer should be centering.}}
\end{table}
...
\dataavailability{We encourage all authors of articles published in Preprints.org to share their research data. In this section, please provide details regarding where data supporting reported results can be found, including links to publicly archived datasets analyzed or generated during the study. Where no new data were created, or where data are unavailable due to privacy or ethical restrictions, a statement is still required. Suggested Data Availability Statements are available in the section ``MDPI Research Data Policies” at \url{https://www.mdpi.com/ethics}.} 
